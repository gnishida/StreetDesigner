...
public:
	...
	static void generateRoadNetwork(RoadGraph &roads, const Polygon2D &area, ExFeature& feature);

private:
	static void generateAvenueSeeds(RoadGraph &roads, const Polygon2D &area, ExFeature& f, std::list<RoadVertexDesc>& seeds);
	...
	static void generateStreetSeeds2(RoadGraph &roads, const Polygon2D &area, ExFeature& kf, std::list<RoadVertexDesc> &seeds);
