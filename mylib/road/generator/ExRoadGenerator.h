...
private:
	...
	static bool growRoadSegment(RoadGraph &roads, const Polygon2D &area, RoadVertexDesc &srcDesc, int roadType, const KDEFeature& f, const KDEFeatureItemEdge &ex_edge, bool confident, float snapFactor, float angleTolerance, std::list<RoadVertexDesc> &seeds);
	...
	static void synthesizeItem2(RoadGraph &roads, RoadVertexDesc v_desc, float organicFactor, KDEFeatureItem &item);
