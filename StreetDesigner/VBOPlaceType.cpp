...
void PlaceType::updateBoundingRectangle(void)
{
	...
	Polygon3D::transformLoop( tmpLoop, this->boundingRectangle, xformMat);
...
int PlaceTypesMainClass::loadPlaceTypeInstancesFromFile ( QString filename, Polygon3D &boundaryPgon )
{
	QFile placeTypesFile(filename);
